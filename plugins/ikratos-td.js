...
let msg = await conn.sendMessage(m.chat, { image: { url: 'https://i.ibb.co/cc8jfkX/01.jpg' }, caption: capt, footer: `تابعني في انستجرام:\nhttps://www.instagram.com/abu_sharkawy11/`, buttons }, { quoted: m })
}
